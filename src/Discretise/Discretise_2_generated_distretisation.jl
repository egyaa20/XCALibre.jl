...
function discretise!(
    eqn::ModelEquation{T,M,E,S,P}, prev, rho_prev, config) where {T<:VectorModel,M,E,S,P}
...
function discretise!(
    eqn::ModelEquation{T,M,E,S,P}, prev, rho_prev, config) where {T<:ScalarModel,M,E,S,P}
