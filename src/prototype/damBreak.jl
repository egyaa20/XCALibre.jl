...
mesh_file = "src/prototype/polyMesh"
...
BCs = assign(
    ...
    (
        ...
        p_rgh = [
            ...
            Dirichlet(:upperWall, operating_pressure),
            Empty(:frontAndBack)
        ],
        alpha = [
            Zerogradient(:leftWall),
...
runtime = Runtime(
    iterations=1050, time_step=1.0e-4, write_interval=10)
...
max_corner_vec = [0.6, 0.3, 0.5] #* scaling
