...
"""
struct Physics{T,F,S,M,Tu,E,D,BI}
    time::T
    fluid::F
    solid::S
    momentum::M 
...
"""
Physics(; time, fluid = Fluid{Default}(), solid, turbulence = RANS{NoTurbulence}(), energy, domain) = begin
# Physics(; time, fluid, turbulence, energy, domain) = begin
    ...
    energy = energy(domain, fluid) #domain, fluid
