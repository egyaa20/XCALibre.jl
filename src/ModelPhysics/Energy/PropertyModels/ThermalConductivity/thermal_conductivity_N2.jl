...
function lambda0_N2(T::Float64, constants::constants_k_N2)
    ...
    term1 = N_L0[1] * (mu_0_val) #MIGHT NEED TO REMOVE THIS!!!
...
# T_input = 125.0	  # Temperature in K
# P_input = 3.4e6 # Pressure
...
# k0 = thermal_conductivity_N2(rho0, T_input, cp0, cv0, kT0, kT_ref, nu_bar)
